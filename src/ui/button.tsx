...
export default function Button({children, variant, modifier, size, fullWidth, disabled, loading, ...props}: ButtonProps) {
	return (
		<button className={button({variant, modifier, size, fullWidth, disabled})} {...props} disabled={Boolean(loading) || Boolean(disabled)}>
