...
const button = cva('relative inline-flex items-center justify-center uppercase enabled:hover:scale-105 transition duration-100 ease-in-out', {
	variants: {
		variant: {
			default: 'text-white bg-toonks-orange enabled:hover:bg-toonks-orangeLight active:focus:ring-4 ring-toonks-orangeLight font-bold',
			primary: 'text-white bg-sky-500 hover:bg-sky-600 active:focus:ring-4 ring-sky-600 font-bold',
		},
		modifier: {
			outline: 'border bg-transparent enabled:hover:text-white',
	...
	compoundVariants: [
		{
			variant: 'default',
			modifier: 'outline',
			className: 'border-toonks-orange',
		},
	],
});
